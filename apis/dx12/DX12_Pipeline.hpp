...
namespace Atrium::DirectX12
{
	...
	class RootSignatureCreator : public Atrium::RootSignatureBuilder
	{
	private:
		class Parameter
		{
	...
	public:
		class DescriptorTable : public RootSignatureBuilder::DescriptorTable, protected Parameter
		{
			friend RootSignatureCreator;
		public:
		...
		class Sampler : public RootSignatureBuilder::Sampler
		{
			friend RootSignatureCreator;
		public:
	...
	public:
		...
		void SetVisibility(Atrium::Shader::Type aShaderVisibility) override;
